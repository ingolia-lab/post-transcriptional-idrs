...
compo_s_pr = read.csv("~/post-transcriptional-idrs/fig6_ms1/idr_logit_models/composition_model_logit_singles/pr_compo_single.csv")
compo_dipep_pr = read.csv('~/post-transcriptional-idrs/fig6_ms1/idr_logit_models/composition_model_logit_withDipeps/pr_compo_dipep.csv')
motif_pr = read.csv('~/post-transcriptional-idrs/fig6_ms1/idr_logit_models/motif_model_logit/pr_motif.csv')
la_pr = read.csv("~/post-transcriptional-idrs/fig6_ms1/idr_logit_models/LightAttention_model/LightAttention_PRC.csv")
...
setwd("~/post-transcriptional-idrs/fig6_ms1/auprc_curves/")
