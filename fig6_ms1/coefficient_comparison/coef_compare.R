...
setwd('~/post-transcriptional-idrs/fig6_ms1/idr_logit_models/composition_model_logit_singles/')
compo_s_coef = read.csv("compo_single_coef.csv")

setwd('~/post-transcriptional-idrs/fig6_ms1/idr_logit_models/motif_model_logit/')
